abstract class Shape
{
    ...
    public final void setWidth(int widthIn) { width = OneGreater(widthIn); }
    public final int getWidth() { return width; }
    private int width;

    public final void setHeight(int heightIn) { height = OneGreater(heightIn); }
    ...
    protected static int OneGreater(int valueIn)
    {
        assert valueIn>=1:"Shape parameter is unexpectedly less than 1.";
